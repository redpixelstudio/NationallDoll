...
namespace RhythmGameStarter
{
    class OnsetDetection
    {
        ...
        // Constructor
        public OnsetDetection(AudioClip clip, int sampleWindow)
        {
            this.clip = clip;
            ...
            float thresholdTimeSpan, float thresholdMultiplier)
        {
            ...
            float sourceTimeSpan = (float)(sampleWindow) / (float)(clip.frequency);
        ...
        public float TimePerSample()
        {
            ...
            return (float)SampleSize / (float)clip.frequency;
        }
