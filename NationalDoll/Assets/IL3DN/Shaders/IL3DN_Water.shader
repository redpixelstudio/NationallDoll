...
Shader "IL3DN/Water"
{
	Properties
	{
		...
		_EdgeReach("Edge Reach", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		uniform half _FoamReach;
		uniform half _EdgeReach;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			half mulTime242 = _Time.y * _Speed;
			...
			half temp_output_387_0 = ( 1.0 - _FoamScale );
			half simplePerlin2D244 = snoise( ( panner253 * 1 )*temp_output_387_0 );
			half2 panner292 = ( 0.1 * _Time.y * float2( -1,0 ) + temp_output_252_0);
			half simplePerlin2D290 = snoise( ( panner292 * 2 )*temp_output_387_0 );
			float largeNoisePattern297 = ( simplePerlin2D244 + simplePerlin2D290 );
			...
			float foamWater218 = ( 1.0 - step( largeNoisePattern297 , ( edgeEffect208 * ( 1.0 - _FoamReach ) ) ) );
			float foamEdge280 = ( 1.0 - step( (0.1 + (_SinTime.w - -1.0) * (0.3 - 0.1) / (1.0 - -1.0)) , ( edgeEffect208 * ( 1.0 - _EdgeReach ) ) ) );
			float topWater237 = saturate( ( 1.0 - edgeEffect208 ) );
			float deepWater170 = saturate( pow( abs( edgeEffect208 ) , abs( _WaterFalloff ) ) );
...
/*ASEBEGIN
Version=18901
1487;127;1601;1451;3646.491;3281.873;1.818331;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;377;-3002.07,-2760.145;Inherit;False;Property;_FoamScale;Foam Scale;13;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;387;-2705.871,-2757.362;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;371;-1916.566,-1509.932;Inherit;False;Property;_FoamReach;Foam Reach;12;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;370;-1934.282,-1888.571;Inherit;False;Property;_EdgeReach;Edge Reach;11;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;386;-1589.678,-1512.798;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;297;-1874.309,-2328.994;Float;False;largeNoisePattern;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;385;-1612.443,-1875.524;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;219;-1497.144,-1605.641;Inherit;False;208;edgeEffect;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;298;-1535.835,-1744.799;Inherit;False;297;largeNoisePattern;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;369;-1262.401,-1958.098;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;356;-1565.957,-1051.706;Inherit;False;1051.563;320.1928;Deep Water Layer;7;94;87;214;10;170;368;388;;0.7678117,1,0,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;372;-1315.088,-1540.667;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;287;-1102.779,-2076.061;Inherit;False;2;0;FLOAT;1;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;214;-1499.294,-973.7419;Inherit;False;208;edgeEffect;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-1584.74,-849.4924;Float;False;Property;_WaterFalloff;Water Falloff;10;0;Create;True;0;0;0;False;0;False;0;-0.5;-1;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.AbsOpNode;388;-1289.312,-941.281;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;87;-1138.399,-900.0184;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;243;-359.0906,-739.1885;Float;False;Property;_Speed;Speed;3;0;Create;True;0;0;0;False;0;False;0;0.025;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;221;-354.4274,-2503.095;Float;False;Property;_FoamColor;Foam Color;6;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;346;-360.7276,-831.2258;Float;False;Property;_Size;Size;2;0;Create;True;0;0;0;False;0;False;0;0.25;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;345;-276.6249,-970.3161;Float;False;Constant;_Vector0;Vector 0;9;0;Create;True;0;0;0;False;0;False;100,100;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;12;-307.5036,-1587.084;Float;False;Property;_BottomColor;Bottom Color;9;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.2781982,0.09593997,0.4150926,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;11;-309.0421,-1386.396;Float;False;Property;_MidColor;Mid Color;8;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.1137238,0.5294118,0.4537714,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;209;-294.1595,-1816.954;Inherit;False;237;topWater;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;202;-310.4486,-2006.183;Float;False;Property;_TopColor;Top Color;7;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.4487242,0.4716981,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;363;-8.35088,-571.2373;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;366;168.3828,-744.7504;Float;False;Property;_NormalStrenght;Normal Strenght;1;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;239;487.8338,-291.6268;Float;False;Property;_Smoothness;Smoothness;5;0;Create;True;0;0;0;False;0;False;1;5;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;213;486.0745,-45.96109;Float;False;Property;_Transparency;Transparency;4;0;Create;True;0;0;0;False;0;False;0;2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FresnelNode;340;888.0751,-376.476;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;362;471.4243,-643.7675;Inherit;True;Property;_Normal02;Normal 02;0;3;[HideInInspector];[NoScaleOffset];[Normal];Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Instance;238;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0.25;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;238;478.2904,-964.1451;Inherit;True;Property;_Normal;Normal;0;2;[NoScaleOffset];[Normal];Create;True;0;0;0;False;0;False;-1;None;76738900a2dcf084990de478555ec33c;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0.25;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FresnelNode;341;891.0469,-133.9227;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0.2;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;349;1162.126,-338.0846;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;294;-2081.411,-2209.335;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;10;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1399.875,-773.275;Half;False;True;-1;2;ASEMaterialInspector;0;0;Standard;IL3DN/Water;False;False;False;False;False;False;True;False;True;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;3;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;False;0;False;Transparent;;Transparent;All;9;d3d9;d3d11_9x;d3d11;glcore;gles;gles3;metal;xboxone;ps4;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;0;4;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;1;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;244;1;387;0
WireConnection;290;0;291;0
WireConnection;290;1;387;0
...
ASEEND*/
//CHKSM=305AA106D5031A901201258632D6AFC902C0EDCD